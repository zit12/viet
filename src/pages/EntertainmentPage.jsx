...
import EntertainmentQuizGame from "../components/EntertainmentQuizGame";
  ...
  const entertainmentQuizzes = [
    {
      ...
      date: "April 5, 2024",
      image: "/movie1.jpg",
      description: "Test your knowledge of famous movies and actors!",
    },
    {
      id: 2,
      ...
      <main className="main-content">
        ...
        <div className="featured-quiz">
          <div className="featured-content">
            <img
              src={entertainmentQuizzes[0].image}
              alt={entertainmentQuizzes[0].title}
              className="featured-image"
            />
            <div className="featured-details">
              <h2>{entertainmentQuizzes[0].title}</h2>
              <p>{entertainmentQuizzes[0].description}</p>
              <button
